...
// #include "/home/arega/.cache/wal/colors-wal-dwm.h"
...
//	"sh", "-c","wal -n -R" , NULL,
//	"sh", "-c","~/.fehbg" , NULL,
	"redshift", "-O", "3700" , NULL,
	"sh", "-c", "~/.config/scripts/dwm-reload-theme.sh", NULL,
	"picom", NULL,
...
static const Key keys[] = {
	...
	{ MODKEY,             			XK_w, 	   spawn,          SHCMD("sxiv -t ~/Imagens/Wallpaper_Shuffle/*") },
...
//	{ ControlMask,           		XK_space,  setlayout,      {0} },
	...
	{ MODKEY,                       XK_F5,     spawn,          SHCMD("~/.config/scripts/set-rand-wallpaper.sh") },
...
//	{ MODKEY,       				XK_Next,   spawn,          SHCMD("sudo brillo -q -u 150000 -U 5") },
	{ ControlMask,       	    	XK_Prior,  spawn,          SHCMD("pamixer -u -i 2") },
	{ ControlMask,       			XK_Next,   spawn,          SHCMD("pamixer -u -d 2") },
	...
	{ ShiftMask,					0x1008ff42,spawn,	   	   SHCMD("xrandr --output eDP-1 --primary --mode 1920x1080 --rate 60 --rotate normal") },
	{ 0,							0x1008ff42,spawn,          SHCMD("xrandr --output eDP-1 --primary --mode 1920x1080 --rate 60 --rotate inverted") },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
